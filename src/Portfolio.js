          ...
          <nav className="navbar mx-5">
            <div className="container-fluid">
              <a className="navbar-brand text-light fs-4 fw-bold" href="/#">
                Soha <span className="std">Studios</span>
              </a>
